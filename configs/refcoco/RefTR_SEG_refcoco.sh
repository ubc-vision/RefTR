...
#     --pretrained_model "./SAVED_MODEL/refcoco_50_det/RefTR_refcoco_l6/checkpoint_best.pth"\
...
python3.8 -u main_vg.py \
    --pretrained_model "./SAVED_MODEL/refcoco_50_det_pretrained/RefTR_refcoco_pt/checkpoint_best.pth"\
    --num_feature_levels 1\
    --num_queries_per_phrase 1\
    --masks\
    --lr 1e-5\
